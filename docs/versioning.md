...
Текущая версия приложения: **v7.0.14**.

Начиная с версии `v4.2.0`, каждый завершённый этап разработки увеличивает
patch-компонент на единицу:

```text
v4.2.0 -> ... -> v5.0.8 -> v6.0.0 -> ... -> v6.0.22 -> v6.0.24 -> v7.0.0 -> v7.0.1 -> v7.0.2 -> v7.0.3 -> v7.0.4 -> v7.0.5 -> v7.0.6 -> v7.0.7 -> v7.0.8 -> v7.0.9 -> v7.0.10 -> v7.0.11 -> v7.0.12 -> v7.0.13 -> v7.0.14
```
