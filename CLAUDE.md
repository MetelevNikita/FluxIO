...
2 (параметрические эфирные эффекты), 3 (импортированный Lottie/alpha-оверлей). Эффект уровня 2
не рисуется напрямую: он *разрешается* в FX-слои, текстовые оверлеи и звуковые вставки, поэтому
supervisor и TSDuck про уровни не знают. Правь по цепочке: настройки в
