...
В v6.0.24 многоязычный звук больше не останавливает эфир: рендерер каждой
звуковой дорожки отдаёт ровно столько сэмплов, сколько длится ролик, независимо
от длительности и характеристик исходного файла перевода. Короткая дорожка
доигрывается тишиной и видна в таймлайне ролика как полоса, не дошедшая до
правого края. Превью роликов восстанавливаются после перезапуска приложения.
