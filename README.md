...
FluxIO — desktop-система эфирного воспроизведения. Одна установка может вести
несколько независимых программ. Каждая анализирует
...
Один ярлык открывает обзор всех программ; оттуда каждая программа запускается
в отдельном операторском окне. Добавление, отключение и мониторинг описаны в
[руководстве по нескольким программам](docs/multiple-programs.md).
...
- [Несколько программ на одном сервере](docs/multiple-programs.md)
